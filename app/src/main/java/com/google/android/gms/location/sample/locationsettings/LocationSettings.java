...
/**
 * Created by Darshan on 2/18/2017.
 */
...
public class LocationSettings implements
    ...
    public LocationSettings(Activity context) {
    ...
    private void init() {
        ...
        if (ContextCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                mContext.requestPermissions(new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
            }
        } else {
            ...
            public void run() {
                if (mCurrentLocation != null) {
                    mContext.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(mContext, "lat:"+mCurrentLocation.getLatitude()+"long:"+mCurrentLocation.getLongitude(), Toast.LENGTH_SHORT).show();
                        }
                    });
                } else {
                    serviceHandler();
